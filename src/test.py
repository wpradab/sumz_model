...
df_demada_test = pd.read_csv(r"C:\Users\Dell\Downloads\drive-download-20241031T211635Z-001 (1)\Datos\demanda_test.csv")
...
data_nueva = preprocesar_nuevos_datos(df_catalogo, df_demada_test)
